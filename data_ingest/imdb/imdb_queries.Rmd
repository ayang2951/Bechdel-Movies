...
# write.csv(movie_data$Released, file = 'movie_data', sep = ',', row.names = FALSE)
```

```{r}

movie_data2 <- movie_data %>% select(Title, Year, Released, Rated, Runtime, Genre, Director, Language, Country, imdbRating, imdbVotes, imdbID, BoxOffice)

write.csv(movie_data2, "imdb_data.csv", row.names = FALSE)
